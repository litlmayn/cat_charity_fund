...
async def create_donation(
    ...
    sources = await charity_project_crud.get_object_in_bd(session)
    new_donations = investment_process(new_donation, sources)
    [session.add(new_donation) for new_donation in new_donations]
